...
urlpatterns = [
    ...
    path(
        "personalbest/<int:pk>/update/",
        views.PersonalBestUpdateView.as_view(),
        name="personalbest-update",
    ),
    path(
    ...
    path(
        "workoutschedule/<int:pk>/update/",
        views.WorkoutScheduleUpdateView.as_view(),
        name="workoutschedule-update",
    ),
    ...
    path(
        "workoutvideos/<int:pk>/update/",
        views.WorkOutVideosUpdateView.as_view(),
        name="workoutvideos-update",
    ),
    path(
        "foodlibrary/<int:pk>/update/",
        views.FoodLibraryUpdateView.as_view(),
        name="foodlibrary-update",
    ),
    path(
        "mealentry/<int:pk>/update/", views.MealEntryUpdateView.as_view(), name="mealentry-update"
    ),
    path(
    ...
    path(
        "personalbest/<int:pk>/delete/",
        views.PersonalBestDeleteView.as_view(),
        name="personalbest-delete",
    ),
    path(
        "userprofile/<int:pk>/delete/",
        views.UserProfileDeleteView.as_view(),
        name="userprofile-delete",
    ),
    path(
        "workoutschedule/<int:pk>/delete/",
        views.WorkoutScheduleDeleteView.as_view(),
        name="workoutschedule-delete",
    ),
    ...
    path(
        "workoutvideos/<int:pk>/delete/",
        views.WorkOutVideosDeleteView.as_view(),
        name="workoutvideos-delete",
    ),
    path(
        "foodlibrary/<int:pk>/delete/",
        views.FoodLibraryDeleteView.as_view(),
        name="foodlibrary-delete",
    ),
    path(
        "mealentry/<int:pk>/delete/", views.MealEntryDeleteView.as_view(), name="mealentry-delete"
    ),
    path(
